...
def create_app() -> Flask:
    ...
    # Doit être initialisé avant l'enregistrement du blueprint pour que
    # prometheus_flask_exporter instrumente bien toutes les routes.
    init_metrics(app)
    ...
    def handle_unexpected_error(err):
        # Ne jamais renvoyer la trace/le message d'exception brut au client.
        logger.error(
            {
